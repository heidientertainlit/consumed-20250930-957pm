...
import { handleLeaderboardRankImageRequest } from "./leaderboard-rank-image";
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.get("/api/leaderboard-rank-image", handleLeaderboardRankImageRequest);
  ...
  // Must be registered before Vite/static catch-all so crawlers receive
  // contextual metadata in the initial HTML response.
  registerOpenGraphRoutes(app, getSupabaseForOG());
