---
name: Friends and matches
description: Product rule for presenting affinity discovery and established friendships in People.
---

Matches and Friends belong in one Friends destination. Lead with search, requests, and invites, then promote the highest-scoring accepted friend into a premium poster-rich “Friend with the closest taste” card. Keep that person out of the remaining friend list, which stays collapsed to five by default. Follow with premium potential friends and compact additional discovery. Keep accepted friends out of match-discovery lists so people are not duplicated. Always label relationship state explicitly: Friend, Wants to connect, Requested, or New match.
