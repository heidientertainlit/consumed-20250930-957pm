...
**Evidence presentation:** Compare is a tall, edge-to-edge white bottom sheet with the feed still visible above it, not a full-screen takeover or dark sheet. Brand results with the purple Consumed logo and “Comparing your Entertainment DNA.” Use recognizable factual side-by-side stats (total tracked, average rating, top media type, optional archetype)—never “positive picks.” Keep up to two “You both liked” titles side by side with portrait posters, larger clickable title links, and media type only—no overlap count, “shared title” copy, pills, or arrows. Keep share actions in a fixed footer outside the scroll area so they are never buried. Do not show “Creators in common” or directional “lean toward” signals; normalized backend tokens can be ambiguous, incorrectly cased, or expose implementation vocabulary without useful context.
