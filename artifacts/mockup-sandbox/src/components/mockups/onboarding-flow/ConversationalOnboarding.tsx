...
const lovedGrid = [
  { title: "Stranger Things", poster: "https://image.tmdb.org/t/p/w300/uOOtwVbSr4QDjAGIifLDwpb2Pdl.jpg" },
  { title: "The Bear", poster: "https://image.tmdb.org/t/p/w300/eKfVzzEazSIjJMrw9ADa2x8ksLz.jpg" },
  { title: "Wicked", poster: "https://image.tmdb.org/t/p/w300/xDGbZ0JJ3mYaGKy4Nzd9Kph6M9L.jpg" },
  { title: "Harry Potter", poster: "https://image.tmdb.org/t/p/w300/wuMc08IPKEatf9rnMNXvIDxqP4W.jpg" },
  { title: "The Office", poster: "https://image.tmdb.org/t/p/w300/7DJKHzAi83BmQrWLrYYOqcoKfhR.jpg" },
  { title: "The Last of Us", poster: "https://image.tmdb.org/t/p/w300/dmo6TYuuJgaYinXBPjrgG9mB5od.jpg" },
];
      ...
      <div className="flex items-center gap-2">
        {[0, 1].map((i) => (
          <div
            ...
            style={{
              width: 56,
              background: i <= step ? "#a855f7" : "rgba(255,255,255,0.14)",
    ...
    return (
      <Phone>
        ...
        <div className="flex-1 flex flex-col px-6 pt-7 pb-10">
          <h1 className="text-center text-[32px] leading-[1.1] font-black">
            Settle
            <br />
            the debate.
          </h1>
          ...
          <button
            ...
            className="mx-auto text-sm text-white/45 font-medium"
          >
    ...
    return (
      <Phone>
        ...
        <div className="flex-1 flex flex-col px-6 pt-6 pb-8">
          <h1 className="text-center text-[28px] leading-[1.15] font-black">
            Which of these
            <br />
            have you <span className="text-purple-400 underline decoration-purple-500 underline-offset-4">loved?</span>
          </h1>
    ...
    <Phone>
      <div className="flex-1 flex flex-col items-center justify-center px-6 pb-8">
        ...
        <div className="flex flex-wrap gap-2 justify-center mt-5">
          {["Story-Driven", "Big Emotion", "Event-Worthy"].map((t) => (
            <span
              key={t}
              className="px-3 py-1.5 rounded-full text-xs font-semibold bg-white/8 border border-purple-400/30 text-purple-200"
            >
              {t}
            </span>
          ))}
        </div>
        <p className="text-[11px] text-white/40 mt-4 flex items-center gap-1.5">
