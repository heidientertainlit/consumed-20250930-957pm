      ...
      <div className="w-[390px] px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <div className="flex gap-2 flex-1">
            <button
              className="flex-1 flex items-center justify-center gap-1.5 h-9 rounded-full text-white/80 text-sm font-medium hover:text-white transition-colors"
              style={{
