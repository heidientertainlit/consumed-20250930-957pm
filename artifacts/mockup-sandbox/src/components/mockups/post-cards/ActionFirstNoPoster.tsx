...
export default function ActionFirstNoPoster() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-start justify-center pt-6 px-4">
      <div className="w-full max-w-sm">
        <p className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-2 text-center">Action First — No Poster</p>
        <div className="bg-white rounded-2xl overflow-hidden" style={{ border: "0.5px solid #e5e7eb" }}>
            ...
            <div className="flex items-center gap-2 mb-3">
              <div className="flex flex-col min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] font-bold uppercase tracking-wide text-violet-500 bg-white/80 px-1.5 py-0.5 rounded-full border border-violet-100">Movie</span>
                </div>
                <p className="text-gray-400 text-[11px] mt-0.5">Have you seen it? Rate it.</p>
              </div>
              <div className="ml-auto shrink-0 flex items-center gap-1 px-2.5 py-1.5 rounded-full" style={{ background: "rgba(124,58,237,0.13)", border: "0.5px solid rgba(124,58,237,0.2)" }}>
          ...
          {/* ── BOTTOM: Marcus's context, subdued ── */}
