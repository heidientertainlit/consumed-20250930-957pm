  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0d0d1a] p-6">
      <div className="w-full max-w-[340px]">
        <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-center mb-3" style={{ color: '#f472b6' }}>D — Fuchsia Rose</p>
        <div
          className="rounded-2xl p-5 flex flex-col justify-between min-h-[210px] relative overflow-hidden"
          style={{ background: 'linear-gradient(160deg, #ec4899 0%, #be185d 50%, #831843 100%)' }}
        >
          {/* Subtle glow overlay */}
          <div className="absolute inset-0 rounded-2xl" style={{ background: 'radial-gradient(circle at 30% 20%, rgba(255,255,255,0.13) 0%, transparent 55%)' }} />
          ...
          <div className="flex items-center justify-between relative z-10">
            ...
            <button className="bg-white text-[#831843] font-bold text-[15px] px-6 py-2.5 rounded-full flex items-center gap-2 shadow-lg">
              Play <span>→</span>
            </button>
          </div>
        </div>
