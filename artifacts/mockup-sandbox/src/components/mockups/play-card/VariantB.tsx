  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0d0d1a] p-6">
      <div className="w-full max-w-[340px]">
        <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-center mb-3" style={{ color: '#4ade80' }}>B — Lime Green</p>
        <div
          className="rounded-2xl p-5 flex flex-col justify-between min-h-[210px] relative overflow-hidden"
          style={{ background: 'linear-gradient(160deg, #65a30d 0%, #16a34a 55%, #14532d 100%)' }}
        >
          {/* Subtle glow overlay */}
          ...
          <div className="flex items-center justify-between relative z-10">
            ...
            <button className="bg-white text-[#14532d] font-bold text-[15px] px-6 py-2.5 rounded-full flex items-center gap-2 shadow-lg">
              Play <span>→</span>
            </button>
          </div>
        </div>
