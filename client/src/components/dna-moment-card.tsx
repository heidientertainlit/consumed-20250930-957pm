    ...
    return (
      <Card className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
        <div className="flex items-center justify-center py-4">
          <Loader2 className="w-5 h-5 animate-spin text-teal-500 opacity-40" />
        </div>
      </Card>
    );
  }
          ...
          return (
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                <h3 className="font-serif text-[24px] font-normal leading-[1.05] tracking-[-.035em] text-[#30203f]">{moment.questionText}</h3>
                {isMulti && !isAnswered && (
