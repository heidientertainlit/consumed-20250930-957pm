          ...
          {!featured ? (
            ...
            <div className="flex flex-col items-center pt-4 pb-2">
              ...
              <div className="flex w-full max-w-[300px] px-2 mt-2">
                <div className="flex flex-col items-center" style={{ width: 100 }}>
                  <span className="font-serif text-[16px] font-medium tracking-[-.02em] text-gray-900 text-center">
                    {session?.user?.user_metadata?.display_name
                      ? formatFeedName(
                          session.user.user_metadata.display_name,
                          session.user.user_metadata.user_name,
        ...
        <div className="pt-4 pb-5 flex flex-col items-center">
          ...
          <div className="flex w-full" style={{ width: 240, marginTop: 2 }}>
            <div className="flex flex-col items-center gap-0.5" style={{ width: 108 }}>
               <span className="font-serif text-[16px] font-medium tracking-[-.02em] text-gray-800 text-center">{posterName}</span>
            ...
            <div style={{ flex: 1 }} />
            <div className="flex flex-col items-center gap-0.5" style={{ width: 108 }}>
               <span className="font-serif text-[16px] font-medium tracking-[-.02em] text-gray-800 text-center">{friendName}</span>
