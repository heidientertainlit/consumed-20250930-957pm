...
export interface UGCPost {
  id: string;
  type: 'ask_for_rec' | 'ask_for_recs' | 'poll' | 'predict' | 'rating' | 'review' | 'thought' | 'cast_approved' | 'rank' | 'finished' | 'general' | 'game_moment' | 'binge_battle' | 'hot_take' | 'question' | 'dna_compare';
  user?: {
    id: string;
    username: string;
    displayName?: string;
