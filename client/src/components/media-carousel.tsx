...
export default function MediaCarousel({
  ...
  return (
    <div className="w-full bg-gradient-to-r from-[#1a1a2e] via-[#2d1f4e] to-[#1a1a2e] rounded-2xl p-3 shadow-lg border border-purple-900/50 overflow-visible" data-testid={`carousel-${mediaType}`}>
      {/* Header */}
      <div className="mb-2">
