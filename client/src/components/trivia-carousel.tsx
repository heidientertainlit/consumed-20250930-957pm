      ...
      <Card className="bg-white border border-gray-200 rounded-2xl p-4 shadow-sm overflow-hidden relative">
        ...
        >
          {filteredData.map((item) => {
                ...
                <div key={item.id} className="flex-shrink-0 w-full snap-center">
                  <div className="flex items-center gap-2 mb-3">
                    <div className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-purple-100 border border-purple-200">
                      <span className="text-xs text-purple-600 font-medium">+{item.pointsReward} pts</span>
                    </div>
                    <div className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-amber-100 border border-amber-200">
                      <span className="text-xs text-amber-600 font-medium">{item.questionCount} questions</span>
                    </div>
                  </div>
            ...
            return (
              <div key={item.id} className="flex-shrink-0 w-full snap-center">
                <div className="inline-flex items-center gap-1 mb-3 px-2 py-0.5 rounded-full bg-purple-100 border border-purple-200">
                  <span className="text-xs text-purple-600 font-medium">+{item.pointsReward} pts</span>
                </div>
                  ...
                  <div className="space-y-2">
                    {item.options.slice(0, 4).map((option, idx) => {
                      ...
                      return (
                        ...
                        >
                          <div 
                            className="absolute left-0 top-0 bottom-0 bg-purple-100 transition-all duration-500"
