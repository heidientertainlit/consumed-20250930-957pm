...
export default function Navigation({ onTrackConsumption }: NavigationProps) {
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-b from-[#0a0a0f] via-[#12121f] to-[#12121f] sticky top-0 z-50">
      ...
      {/* Bottom navigation */}
      <nav className="fixed bottom-0 left-0 right-0 z-50" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)', background: 'linear-gradient(to right, #0a0a0f, #12121f, #2d1f4e)' }}>
