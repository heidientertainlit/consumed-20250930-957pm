...
export function DailyChallengeCard() {
  ...
  if (challengeLoading) {
    return (
      <Card className="p-4 bg-gradient-to-r from-purple-900 via-indigo-900 to-blue-900 border-0">
  ...
  return (
    <Card 
      className="bg-gradient-to-r from-purple-900 via-indigo-900 to-blue-900 border border-purple-500/30 rounded-xl overflow-hidden cursor-pointer active:scale-[0.98] transition-transform"
