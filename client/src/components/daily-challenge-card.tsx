...
export function DailyChallengeCard() {
  ...
  if (challengeLoading) {
    return (
      <Card className="p-4 bg-gradient-to-r from-slate-800 via-indigo-950 to-blue-950 border-0">
  ...
  return (
    <Card 
      className="bg-gradient-to-r from-slate-800 via-indigo-950 to-blue-950 border border-indigo-500/30 rounded-xl overflow-hidden cursor-pointer active:scale-[0.98] transition-transform"
