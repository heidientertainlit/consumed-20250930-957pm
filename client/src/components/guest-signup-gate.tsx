  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-end justify-center" data-testid="guest-signup-sheet">
      ...
      <div className="relative w-full max-w-md mx-auto bg-white border-t border-gray-200 rounded-t-3xl p-6 pb-10 shadow-[0_-16px_48px_rgba(15,23,42,.18)] animate-in slide-in-from-bottom duration-300">
        ...
        <div className="mb-6 grid grid-cols-[2.75rem_minmax(0,1fr)] gap-x-3 pr-10">
          <div className="row-span-2 flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[linear-gradient(135deg,#7c3aed_0%,#4f46e5_55%,#2563eb_100%)] shadow-[0_5px_16px_rgba(79,70,229,.28)]">
          ...
          <p className="mt-1 max-w-[18rem] text-gray-600 text-sm leading-relaxed">
