...
export function RecommendationsGlimpse() {
  ...
  const handleAddClick = (item: RecommendedItem) => {
    ...
    <>
      ...
      {quickAddItem && (
        <QuickAddListSheet
          ...
          media={{
            title: quickAddItem.title,
            mediaType: quickAddItem.type,
            externalId: quickAddItem.id,
            externalSource: quickAddItem.externalSource || 'tmdb',
            imageUrl: quickAddItem.imageUrl
          }}
        />
      )}
    </>
