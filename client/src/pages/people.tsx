...
export default function PeoplePage() {
  ...
  return <div className="min-h-[100dvh] pb-24 bg-[#faf9fb] text-[#29233b]">
    ...
    <main className="max-w-5xl mx-auto px-4 sm:px-6 pt-6 sm:pt-10">
      ...
      {mode === "tribes" && <section className="-mx-4 mt-0 bg-[#f2f0f4] px-4 pb-6 pt-7 animate-in fade-in duration-300 sm:-mx-6 sm:px-6">
