...
const CHALLENGE_BANKS: Record<string, Record<Difficulty, Omit<Question, "id" | "points">[]>> = {
  ...
  "Friends": {
    easy: [
      ...
      { text: "What song does Phoebe sing at Central Perk?", options: ["Smelly Cat", "Sticky News", "Hairy Bear", "Lonely Dog"], correctAnswer: "Smelly Cat" },
    ...
    medium: [
      ...
      { text: "Which fashion brand does Rachel work for in the later seasons?", options: ["Ralph Lauren", "Gucci", "Prada", "Donna Karan"], correctAnswer: "Ralph Lauren" },
    ...
    hard: [
      ...
      { text: "What accidentally happens to Chandler's toe in a Thanksgiving episode?", options: ["Monica drops a knife on it", "He kicks a piece of furniture", "A frozen turkey falls on it", "Ross accidentally steps on it"], correctAnswer: "Monica drops a knife on it" },
      ...
      { text: "What is the name of Chandler's roommate who moves in after Joey leaves?", options: ["Eddie", "Kip", "Gary", "Derek"], correctAnswer: "Eddie" },
      { text: "What country does Chandler pretend to be moving to in order to break up with Janice?", options: ["Yemen", "Dubai", "Bosnia", "Bangladesh"], correctAnswer: "Yemen" },
