      ...
      <div className="max-w-4xl mx-auto px-4 pt-6 pb-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-300 text-sm">
            Premium prediction pools with 2x point payouts
          </p>
        </div>
        ...
        <DialogContent className="bg-gradient-to-br from-gray-900 to-purple-900 border-amber-500/30 text-white max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray-300">
              Confirm your prediction to enter the high stakes pool
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 mt-4">
            <div className="bg-black/30 rounded-lg p-4 space-y-3">
              ...
              <div className="border-t border-gray-700 pt-3 mt-3">
                <div className="flex justify-between text-lg">
                  <span className="text-white font-medium">Entry Cost:</span>
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
              <p className="text-amber-200 text-sm">
                💡 High stakes pools require points to enter. Win big with 2x point multipliers!
              </p>
            </div>
            ...
            <div className="flex gap-3">
              ...
              >
                Enter with {selectedGame?.entryFee}
              </Button>
            </div>
          </div>
        </DialogContent>
