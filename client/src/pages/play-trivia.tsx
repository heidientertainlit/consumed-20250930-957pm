  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        {/* Quick Glimpse - Recent Trivia Activity */}
        {(() => {
          const recentActivity = [
            { name: 'Sarah', action: 'scored 80 pts on 90s Sitcoms Trivia', points: 80 },
            { name: 'Mike', action: 'completed Movie Quotes Challenge', points: 60 },
            { name: 'Emma', action: 'scored 100 pts on Marvel Trivia', points: 100 },
            { name: 'Alex', action: 'finished TV Theme Songs quiz', points: 40 },
            { name: 'Jordan', action: 'aced the Oscar Winners Challenge', points: 90 },
            { name: 'Taylor', action: 'scored 70 pts on Music Legends', points: 70 },
          ];
          
          if (recentActivity.length < 2) return null;
          
          return (
            <div className="mb-6 bg-purple-50 rounded-2xl p-3 border border-purple-100 shadow-sm overflow-hidden" data-testid="quick-glimpse-trivia">
              ...
              <div className="h-[72px] overflow-hidden">
                <div 
                  ...
                  style={{
                    animation: `scrollVerticalGlimpseTrivia ${recentActivity.length * 3}s linear infinite`,
                  }}
                >
                  {[...recentActivity, ...recentActivity].map((activity, idx) => (
                    <div 
                      key={`glimpse-trivia-${idx}`}
              ...
              <style>{`
                @keyframes scrollVerticalGlimpseTrivia {
