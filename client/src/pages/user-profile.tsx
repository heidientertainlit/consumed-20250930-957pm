        ...
        {activeSection === 'collections' && isOwnProfile && (
          <div ref={listsRef} className="px-4 mb-8">
            <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
              ...
              {/* Tabs for Lists/History */}
              <Tabs value={collectionsSubTab} onValueChange={(v) => setCollectionsSubTab(v as 'lists' | 'history')} className="w-full">
                <TabsList className="w-full mb-3 bg-gray-100 border border-gray-200 p-1 h-auto">
                  <TabsTrigger 
                    value="lists" 
                  ...
                  {isLoadingLists ? (
                    ...
                    <div className="space-y-2">
                      {userLists
                        ...
                        <div
                          key={list.id}
                          className="bg-gray-50 border border-gray-200 rounded-xl hover:border-purple-300 transition-colors cursor-pointer"
                          onClick={() => {
                            const listSlug = list.title.toLowerCase().replace(/\s+/g, '-');
                            const userParam = !isOwnProfile && viewingUserId ? `?user=${viewingUserId}` : '';
                            setLocation(`/list/${listSlug}${userParam}`);
                        ...
                        >
                          <div className="px-4 py-3 flex items-center justify-between">
                            <div className="flex items-center gap-3 flex-1">
                              ...
                              <div className="flex-1">
                                <div className="flex items-center gap-2">
                                  <h4 className="font-semibold text-gray-900">{getDisplayTitle(list.title)}</h4>
