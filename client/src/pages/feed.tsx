              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-4 shadow-sm">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-gray-800 mt-2">Looking for recommendations! What should I watch/read/listen to next? 🎬📚🎵</p>
                    ...
                    <div className="flex items-center gap-4 mt-3 pt-3 border-t border-gray-100">
                      ...
                      <button className="flex items-center gap-1.5 text-gray-500 hover:text-purple-600 transition-colors">
                        ...
                        <span className="text-xs">8 recommendations</span>
                      </button>
                    </div>
                    ...
                    <div className="mt-3 pt-3 border-t border-gray-100 space-y-3">
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            <p className="font-medium text-sm">Mia Patel</p>
