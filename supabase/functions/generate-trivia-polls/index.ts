...
- show_tag: REQUIRED for trivia — the PRIMARY media item this question is about (e.g. "Stranger Things", "Taylor Swift", "The Dark Knight"). NEVER null for trivia. For polls/dna_moment/featured_play: set if question references a specific title, otherwise null. When a question compares two items, set show_tag to the one the question is more "about" (or the first mentioned). CRITICAL: show_tag must NEVER be the same as correct_answer — if the answer to the question IS the media title itself (e.g. "Who won the Grammy for Album of the Year?" → "U2", show_tag = "U2"), rewrite the question so the answer is a detail ABOUT the media, not the media name itself. The show_tag is shown to players as context before they answer — it must not give away the answer.
