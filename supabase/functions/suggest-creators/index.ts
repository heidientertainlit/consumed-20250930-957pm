...
const POPULAR: { name: string; role: string }[] = [
  ...
  // Authors — mega-bestsellers only
  { name: 'Colleen Hoover', role: 'Author' }, { name: 'Stephen King', role: 'Author' },
  { name: 'Sarah J. Maas', role: 'Author' }, { name: 'Rebecca Yarros', role: 'Author' },
  { name: 'James Patterson', role: 'Author' }, { name: 'Emily Henry', role: 'Author' },
  { name: 'Taylor Jenkins Reid', role: 'Author' }, { name: 'Freida McFadden', role: 'Author' },
  { name: 'Kristin Hannah', role: 'Author' }, { name: 'Nicholas Sparks', role: 'Author' },
  { name: 'John Grisham', role: 'Author' }, { name: 'Delia Owens', role: 'Author' },
  { name: 'Suzanne Collins', role: 'Author' }, { name: 'J.K. Rowling', role: 'Author' },
  { name: 'George R.R. Martin', role: 'Author' }, { name: 'Gillian Flynn', role: 'Author' },
  { name: 'Liane Moriarty', role: 'Author' }, { name: 'Jodi Picoult', role: 'Author' },
  { name: 'Brandon Sanderson', role: 'Author' }, { name: 'Dan Brown', role: 'Author' },
  // Musicians
