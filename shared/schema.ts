...
export const users = pgTable("users", {
  ...
  peopleDiscoverable: boolean("people_discoverable").notNull().default(true),
...
export const roomTakes = pgTable("room_takes", {
  ...
  hasSpoiler: boolean("has_spoiler").default(false),
  rating: real("rating"),
  mediaTitle: text("media_title"),
  mediaType: text("media_type"),
  mediaCreator: text("media_creator"),
  ...
  mediaExternalId: text("media_external_id"),
  mediaExternalSource: text("media_external_source"),
  mediaSubtype: text("media_subtype"),
  mediaSeasonNumber: integer("media_season_number"),
  mediaEpisodeNumber: integer("media_episode_number"),
  mediaEpisodeTitle: text("media_episode_title"),
